      ...
      >
        <div id="fixedPluginClasses" className={this.props.fixedClasses}>
          ...
          <ul className="dropdown-menu">
            ...
            <li className="button-container">
              <FacebookShareButton url="https://creativetimofficial.github.io/material-dashboard-pro-react/#/dashboard">
                <FacebookIcon size={32} round={true} />
              </FacebookShareButton>
              <TwitterShareButton
                url="https://creativetimofficial.github.io/material-dashboard-pro-react/#/dashboard"
                title="Material Dashboard PRO React - Premium Material-UI Admin Template"
            ...
            <li className="button-container">
              <GitHubButton
                ...
                repo="ct-material-dashboard-pro-react"
              />
            </li>
          </ul>
        </div>
